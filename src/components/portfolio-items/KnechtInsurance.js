  ...
  return (
    <div className='portfolio-portfolioItem'>
        ...
        <div className='portfolio-portfolioItemText' id='portfolio-blindsTrackerText'>
            ...
            <p>This is a website that a colleague and I built for an insurance broker using HTML, CSS, and vanilla JavaScript.
            ...
            <div className='portfolio-portfolioButtonContainer'>
                ...
                <div className='portfolio-portfolioButton'>
                    <a href='https://github.com/miwaro/knecht-insurance' className='button' target='blank'>View Source Code</a>
                </div>
            </div>
        </div>
    </div>
